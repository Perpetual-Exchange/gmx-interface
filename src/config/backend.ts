...
export const GMX_STATS_API_URL = "https://dapptest.rollex.finance/api";

const BACKEND_URLS = {
  // default: "https://gmx-server-mainnet.uw.r.appspot.com",
  default: "https://dapptest.rollex.finance/api",

  [MAINNET]: "https://gambit-server-staging.uc.r.appspot.com",
  [ARBITRUM_TESTNET]: "https://gambit-server-devnet.uc.r.appspot.com",
  [AVALANCHE_FUJI]: "https://dapptest.rollex.finance/api",
  [ROLLEX_TESTNET]: "https://dapptest.rollex.finance/api",
};

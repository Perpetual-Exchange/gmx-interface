...
const SUBGRAPH_URLS = {
  ...
  // 待定
  [ROLLEX_TESTNET]: {
    stats: "https://rollux.graph.rpc.tanenbaum.io/subgraphs/name/rollex/rollex-rt-stats",
    referrals: "https://rollux.graph.rpc.tanenbaum.io/subgraphs/name/rollex/rollex-rt-referrals",
  },
};

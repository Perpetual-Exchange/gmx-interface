      ...
      <div className="default-container Page page-layout">
        <div>
          <div className="Page-title-section center">
            <div className="Page-title">ODX</div>
          ...
          <div className="content">
            <div className="section">
              ...
              <p className="body-text">
                ...
                and conditions by which you may access ODX.finance ("the Site") and app.ODX.finance ("the Interface").
            ...
            <div className="section">
              ...
              <p className="body-text">The ODX.finance site is for informational purposes only.</p>
              <p className="body-text">
                ODX.finance is not part of any transaction on the blockchain networks underlying the ODX Protocol; we do
                ...
                receive any crypto assets. You understand that when you interact with any ODX Protocol smart contracts,
                  ...
                  <ul className="list-style-none">
                    ...
                    <li>
                      <p className="body-text">
                        ...
                        administrative authority having jurisdiction over ODX.finance or you as otherwise duly enacted,
                  ...
                  <ul className="list-style-none">
                    <li>
                      <p className="body-text">
                        ...
                        procedures or repairs that ODX.finance or any of its suppliers or contractors may undertake from
                        time to time; (c) causes beyond ODX.finance's control or that ODX.finance could not reasonably
                    ...
                    <li>
                      <p className="body-text">
                        ...
                        transaction with ODX.finance;
                      </p>
                    </li>
                    <li>
                      <p className="body-text">1.2.5. ODX.finance does not act as a broker or advisor for you;</p>
                    </li>
                    <li>
                      <p className="body-text">
            ...
            <div className="section">
              ...
              <p className="body-text">
                ...
                fees. ODX.finance does not receive fees for any blockchain transactions or using the Site or the
                Interface.
              </p>
            </div>
            <div className="section">
            ...
            <div className="section">
              ...
              <ul className="list-style-none">
                <li>
                  <p className="body-text">
                    4.1. ODX.finance own all rights, names, logos, and other marks used on the Site and the Interface,
                    including, without limitation, any copyrights in and to any content, code, data, or other materials
                    that you may access or use on or through the Site or the Interface; however, the code for the ODX
                    Protocol and the Interface (app.ODX.finance) deployed on IPFS is open-sourced. Except as expressly
                ...
                <li>
                  <p className="body-text">
                    4.2. ODX.finance may use and share your comments, bug reports, ideas, or other feedback that you may
                    provide, including suggestions about how we might improve. You agree that ODX.finance is free to use
            ...
            <div className="section">
              ...
              <ul className="list-style-none">
                <li>
                  <p className="body-text">
                    5.1. ODX.finance reserve the right, at our sole discretion, from time to time and with or without
                    ...
                    do not host or own its code. ODX.finance will not be liable for any losses suffered by you resulting
                ...
                <li>
                  <p className="body-text">
                    5.2. ODX.finance may revise these Terms from time to time. We will notify you by updating the date
              ...
              <ul className="list-style-none">
                <li>
                  <p className="body-text">
                    ...
                    others, entails a risk that by accessing transactions, you are assuming. ODX.finance does not own or
                  ...
                  <ul className="list-style-none">
                    <li>
                      <p className="body-text">
                        6.1.1. That ODX.finance is not responsible for the operation of the open-source software and
                    ...
                    <li>
                      <p className="body-text">
                        ...
                        blockchain-based network. Neither ODX.finance nor any other person or entity will be able to
                ...
                <li>
                  <p className="body-text">
                    6.2. ODX.finance is not responsible for the content of any third party, including, but not limited
                    to, information, materials, products, or services that ODX.finance does not own or control. In
                    addition, third parties may offer promotions related to your access and use of the Interface.
                    ODX.finance does not endorse or assume any responsibility for such resources or promotions. Suppose
                    ...
                    third parties. You expressly relieve ODX.finance of all liability arising from using such resources
                ...
                <li>
                  <p className="body-text">
                    6.6. You hereby assume and agree that ODX.finance will have no responsibility or liability for the
                    risks in Section 9. You hereby irrevocably waive, release and discharge all claims, whether known or
                    unknown to you, against ODX.finance, its affiliates, and their respective shareholders, members,
                  ...
                  <ul className="list-style-none">
                    ...
                    <li>
                      <p className="body-text">
                        ...
                        right of publicity, privacy, or any other proprietary right of ODX.finance;
                      </p>
                    </li>
                    <li>
                      <p className="body-text">
                    ...
                    <li>
                      <p className="body-text">
                        7.1.6. Harass, abuse, or harm another person or entity, including ODX.finance's collaborator and
                        service providers;
                      </p>
                    </li>
                    <li>
            ...
            <div className="section">
              ...
              <p className="body-text">
                ODX.finance is an informational site for the ODX Protocol. ODX.finance does not operate an exchange
              ...
              <p className="body-text">
                You understand that ODX.finance is not registered or licensed by any regulatory agency or authority. No
              ...
              <p className="body-text">
                ...
                ODX.finance makes no guarantees of any kind or connection with the Site or the Interface.
              </p>
            </div>
            <div className="section">
              <h3 className="body-title">9. LIMITATION OF LIABILITY</h3>
              <p className="body-text">
                In no event shall ODX.finance, its affiliates, its suppliers and contractors, and its affiliates',
                ...
                or the Interface, or other item provided by or on behalf of ODX.finance, whether under contract, tort
                ...
                or any limited remedy hereunder nor is ODX.finance in any way responsible for the execution or
                settlement of transactions between users of the Interface.
              </p>
              <p className="body-text">
                In no event shall ODX.finance's aggregate liability arising out of or in connection with the Site or
            ...
            <div className="section">
              ...
              <p className="body-text">
                You will defend, indemnify, and hold harmless ODX.finance, its affiliates, members, member, managers,
            ...
            <div className="section">
              ...
              <p className="body-text">
                ODX.finance will use its best efforts to resolve potential disputes through informal, good faith
                negotiations. If a potential dispute arises, you must contact us by sending a written notice of your
                claim ("Notice") to ODX.finance on any of our official channels. The notice must (a) describe the nature
                and basis of the claim and (b) set forth the specific relief sought. Our notice to you will be similar
                in form to that described above. If you and ODX.finance cannot reach an agreement to resolve the claim
                within sixty (60) days of your email, then you and ODX.finance agree to resolve the potential dispute
              ...
              <p className="body-text">
                ...
                ODX.finance will not have the right to assert the claim.
              </p>
            </div>
            <div className="section">
            ...
            <div className="section">
              ...
              <ul className="list-style-none">
                <li>
                  <p className="body-text">
                    13.1. Any right or remedy of ODX.finance set forth in these Terms is in addition to, and not in lieu
                    of, any other right or remedy whether described in these Terms, under Applicable Law, at law, or in
                    equity. The failure or delay of ODX.finance in exercising any right, power, or privilege under these
                ...
                <li>
                  <p className="body-text">
                    13.4. ODX.finance will have no responsibility or liability for any failure or delay in performance
                ...
                <li>
                  <p className="body-text">
                    13.6. These Terms contain the entire agreement between you and ODX.finance and supersede all prior
            ...
            <div className="section">
              ...
              <p className="body-text">
                ...
                ODX.finance on any of our official channels.
              </p>
            </div>
          </div>
        </div>

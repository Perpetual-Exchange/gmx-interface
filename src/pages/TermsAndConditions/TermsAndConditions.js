      ...
      <div className="default-container Page page-layout">
        <div>
          <div className="Page-title-section center">
            <div className="Page-title">REX</div>
          ...
          <div className="content">
            <div className="section">
              <p className="body-text">
                Welcome to REX.finance ("we," "us," or "our"), the informational resource for REX Protocol, as defined
                below.
              </p>
              <p className="body-text">
                REX.finance provides information and resources about the fundamentals of the decentralized non-custodial
                protocol called the REX Protocol (the "REX Protocol," "Protocol," or "REX DApp"). REX.finance is not an
              ...
              <p className="body-text">
                ...
                and conditions by which you may access REX.finance ("the Site") and app.REX.finance ("the Interface").
            ...
            <div className="section">
              ...
              <p className="body-text">The REX.finance site is for informational purposes only.</p>
              <p className="body-text">
                REX.finance is not part of any transaction on the blockchain networks underlying the REX Protocol; we do
                ...
                receive any crypto assets. You understand that when you interact with any REX Protocol smart contracts,
                  ...
                  <ul className="list-style-none">
                    ...
                    <li>
                      <p className="body-text">
                        ...
                        administrative authority having jurisdiction over REX.finance or you as otherwise duly enacted,
                  ...
                  <ul className="list-style-none">
                    <li>
                      <p className="body-text">
                        ...
                        procedures or repairs that REX.finance or any of its suppliers or contractors may undertake from
                        time to time; (c) causes beyond REX.finance's control or that REX.finance could not reasonably
                    ...
                    <li>
                      <p className="body-text">
                        ...
                        transaction with REX.finance;
                      </p>
                    </li>
                    <li>
                      <p className="body-text">1.2.5. REX.finance does not act as a broker or advisor for you;</p>
                    </li>
                    <li>
                      <p className="body-text">
            ...
            <div className="section">
              ...
              <p className="body-text">
                ...
                fees. REX.finance does not receive fees for any blockchain transactions or using the Site or the
                Interface.
              </p>
            </div>
            <div className="section">
            ...
            <div className="section">
              ...
              <ul className="list-style-none">
                <li>
                  <p className="body-text">
                    4.1. REX.finance own all rights, names, logos, and other marks used on the Site and the Interface,
                    including, without limitation, any copyrights in and to any content, code, data, or other materials
                    that you may access or use on or through the Site or the Interface; however, the code for the REX
                    Protocol and the Interface (app.REX.finance) deployed on IPFS is open-sourced. Except as expressly
                ...
                <li>
                  <p className="body-text">
                    4.2. REX.finance may use and share your comments, bug reports, ideas, or other feedback that you may
                    provide, including suggestions about how we might improve. You agree that REX.finance is free to use
            ...
            <div className="section">
              ...
              <ul className="list-style-none">
                <li>
                  <p className="body-text">
                    5.1. REX.finance reserve the right, at our sole discretion, from time to time and with or without
                    ...
                    do not host or own its code. REX.finance will not be liable for any losses suffered by you resulting
                ...
                <li>
                  <p className="body-text">
                    5.2. REX.finance may revise these Terms from time to time. We will notify you by updating the date
              ...
              <ul className="list-style-none">
                <li>
                  <p className="body-text">
                    ...
                    others, entails a risk that by accessing transactions, you are assuming. REX.finance does not own or
                  ...
                  <ul className="list-style-none">
                    <li>
                      <p className="body-text">
                        6.1.1. That REX.finance is not responsible for the operation of the open-source software and
                    ...
                    <li>
                      <p className="body-text">
                        ...
                        blockchain-based network. Neither REX.finance nor any other person or entity will be able to
                ...
                <li>
                  <p className="body-text">
                    6.2. REX.finance is not responsible for the content of any third party, including, but not limited
                    to, information, materials, products, or services that REX.finance does not own or control. In
                    addition, third parties may offer promotions related to your access and use of the Interface.
                    REX.finance does not endorse or assume any responsibility for such resources or promotions. Suppose
                    ...
                    third parties. You expressly relieve REX.finance of all liability arising from using such resources
                ...
                <li>
                  <p className="body-text">
                    6.6. You hereby assume and agree that REX.finance will have no responsibility or liability for the
                    risks in Section 9. You hereby irrevocably waive, release and discharge all claims, whether known or
                    unknown to you, against REX.finance, its affiliates, and their respective shareholders, members,
                  ...
                  <ul className="list-style-none">
                    ...
                    <li>
                      <p className="body-text">
                        ...
                        right of publicity, privacy, or any other proprietary right of REX.finance;
                      </p>
                    </li>
                    <li>
                      <p className="body-text">
                    ...
                    <li>
                      <p className="body-text">
                        7.1.6. Harass, abuse, or harm another person or entity, including REX.finance's collaborator and
                        service providers;
                      </p>
                    </li>
                    <li>
            ...
            <div className="section">
              ...
              <p className="body-text">
                REX.finance is an informational site for the REX Protocol. REX.finance does not operate an exchange
              ...
              <p className="body-text">
                You understand that REX.finance is not registered or licensed by any regulatory agency or authority. No
              ...
              <p className="body-text">
                ...
                REX.finance makes no guarantees of any kind or connection with the Site or the Interface.
              </p>
            </div>
            <div className="section">
              <h3 className="body-title">9. LIMITATION OF LIABILITY</h3>
              <p className="body-text">
                In no event shall REX.finance, its affiliates, its suppliers and contractors, and its affiliates',
                ...
                or the Interface, or other item provided by or on behalf of REX.finance, whether under contract, tort
                ...
                or any limited remedy hereunder nor is REX.finance in any way responsible for the execution or
                settlement of transactions between users of the Interface.
              </p>
              <p className="body-text">
                In no event shall REX.finance's aggregate liability arising out of or in connection with the Site or
            ...
            <div className="section">
              ...
              <p className="body-text">
                You will defend, indemnify, and hold harmless REX.finance, its affiliates, members, member, managers,
            ...
            <div className="section">
              ...
              <p className="body-text">
                REX.finance will use its best efforts to resolve potential disputes through informal, good faith
                negotiations. If a potential dispute arises, you must contact us by sending a written notice of your
                claim ("Notice") to REX.finance on any of our official channels. The notice must (a) describe the nature
                and basis of the claim and (b) set forth the specific relief sought. Our notice to you will be similar
                in form to that described above. If you and REX.finance cannot reach an agreement to resolve the claim
                within sixty (60) days of your email, then you and REX.finance agree to resolve the potential dispute
              ...
              <p className="body-text">
                ...
                REX.finance will not have the right to assert the claim.
              </p>
            </div>
            <div className="section">
            ...
            <div className="section">
              ...
              <ul className="list-style-none">
                <li>
                  <p className="body-text">
                    13.1. Any right or remedy of REX.finance set forth in these Terms is in addition to, and not in lieu
                    of, any other right or remedy whether described in these Terms, under Applicable Law, at law, or in
                    equity. The failure or delay of REX.finance in exercising any right, power, or privilege under these
                ...
                <li>
                  <p className="body-text">
                    13.4. REX.finance will have no responsibility or liability for any failure or delay in performance
                ...
                <li>
                  <p className="body-text">
                    13.6. These Terms contain the entire agreement between you and REX.finance and supersede all prior
            ...
            <div className="section">
              ...
              <p className="body-text">
                ...
                REX.finance on any of our official channels.
              </p>
            </div>
          </div>
        </div>

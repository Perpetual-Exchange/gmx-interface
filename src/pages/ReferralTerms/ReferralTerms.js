...
export default function ReferralTerms() {
  return (
    <SEO title={getPageTitle(t`Referral Terms`)}>
      <div className="default-container Page page-layout" style={{marginTop:'4rem'}}>
        <div>
          <div className="Page-title-section center">
            <div className="Page-title">NOX Referral Program</div>
          ...
          <div className="content">
            <div className="section">
              <p className="body-text">
                Welcome to neonnexus.io ("we," "us," or "our"), the informational resource for NOX Protocol, as defined
                below.
              </p>
              <p className="body-text">
                neonnexus.io provides information and resources about the fundamentals of the decentralized non-custodial
                protocol called the NOX Protocol (the "NOX Protocol," "Protocol," or "NOX DApp"). neonnexus.io is not an
              ...
              <p className="body-text">
                ...
                Affiliate"), explains the terms and conditions by which you may use the NOX Referral Program ("Referral
            ...
            <div className="section">
              ...
              <p className="body-text">
                The Referral Program allows you to advertise the NOX DApp, thereby driving traffic to it, whereby you
                may earn a portion of the fees generated ("Rebates") if a person that is not you ("Trader," "Referred
                User") trades in the NOX DApp after being referred to it from a hyperlink ("Link") or manually input
                code ("Referral Code"). The Trader will benefit from a fee discount ("Discount") associated with the
                Referrer's tier.
              </p>
              <p className="body-text">
                After being referred to the NOX DApp from a Link, the Trader's browser will save your Referral Code,
            ...
            <div className="section">
              ...
              <p className="body-text">
                2.1 As an Affiliate, NOX DApp provides you with the Links and Referral Codes necessary to promote the
                NOX Protocol. You acknowledge and agree it is your sole responsibility to indicate your correct Referral
                Code. You may promote the NOX Protocol offers in any manner you choose unless it misleads someone about
                the NOX Protocol.
              </p>
              <p className="body-text">
                2.2 neonnexus.io is not responsible for (i) lost sales or lost opportunity to earn Rebates due to any
              ...
              <p className="body-text">
                2.3 You will be excluded from the Referral Program, following the directives of the NOX tokenholders:
            ...
            <div className="section">
              ...
              <p className="body-text">
                neonnexus.io is under no obligation for Rebates or Discounts to any Referrer or Trader. Rebates and
                Discounts are handled following the directives of the NOX tokenholders.
              </p>
              <p className="body-text">
                ...
                <ExternalLink href="https://docs.neonnexus.io/referrals">
                  https://docs.neonnexus.io/referrals.
                </ExternalLink>
              </p>
            </div>
            <div className="section">
              ...
              <p className="body-text">
                Under no circumstances shall neonnexus.io be liable for any direct, indirect, incidental, punitive,
              ...
              <p className="body-text">
                In no event shall neonnexus.io's aggregate liability arising out of or in connection with the Site exceed
            ...
            <div className="section">
              ...
              <p className="body-text">
                You will defend, indemnify, and hold harmless neonnexus.io, its affiliates, members, member, managers,
                ...
                service(s) provided by neonnexus.io, or your use of the service(s) provided by neonnexus.io, including,
            ...
            <div className="section">
              ...
              <p className="body-text">
                The Referral Program runs independently from neonnexus.io, which the token holders of NOX determine. Due
              ...
              <p className="body-text">
                neonnexus.io will not be liable for any losses suffered by you resulting from any modification to the
              ...
              <p className="body-text">
                neonnexus.io may revise these Terms from time to time. We will notify you by updating the date at the top
                of the Terms and maintaining a current version. The most current version of the Terms will always be at
                https://neonnexus.io/#/referral-terms. All modifications will be effective when they are posted. By using the
            ...
            <div className="section">
              ...
              <p className="body-text">
                ...
                only agreement between you and neonnexus.io concerning the subject matter of these Terms and supersede
              ...
              <p className="body-text">
                ...
                unenforceable or invalid as a whole. neonnexus.io will amend or replace such provision with one that is
              ...
              <p className="body-text">
                ...
                or in connection with any change of control. neonnexus.io may assign or transfer any or all of our rights
                or obligations under these Terms, in whole or part, without notice or obtaining your consent or
                approval.
              </p>
              <p className="body-text">
                8.6 neonnexus.io will have no responsibility or liability for any failure or delay in performance of the
            ...
            <div className="section">
              ...
              <p className="body-text">
                ...
                neonnexus.io on any of our official channels.
              </p>
            </div>
          </div>
        </div>

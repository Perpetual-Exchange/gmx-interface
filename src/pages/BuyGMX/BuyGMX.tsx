        ...
        <div className="section-title-block">
          <div className="section-title-content">
            <div className="Page-title">
              <Trans>Buy ODX on {getChainName(chainId)}</Trans>
            </div>
            <div className="Page-description">
              <Trans>Choose to buy from decentralized or centralized exchanges.</Trans>
              <br />
              <Trans>
                To purchase ODX on the {isArbitrum ? "Avalanche" : "Arbitrum"} blockchain, please{" "}
...
function DecentralisedExchanges({ chainId, externalLinks }) {
  const isArbitrum = chainId === ARBITRUM;
  return (
    <Card title={t`Buy ODX from decentralized exchanges`}>
      <div className="App-card-content">
        {isArbitrum ? (
          <div className="exchange-info-group">
            <div className="BuyGMXGLP-description">
              <Trans>Buy ODX from Uniswap (make sure to select Arbitrum):</Trans>
            </div>
          ...
          <div className="exchange-info-group">
            <div className="BuyGMXGLP-description">
              <Trans>Buy ODX from Traderjoe:</Trans>
            </div>
            <div className="col-1 buttons-group">
              <Button
                variant="secondary"
        ...
        <div className="exchange-info-group">
          <div className="BuyGMXGLP-description">
            <Trans>Buy ODX using Decentralized Exchange Aggregators:</Trans>
          </div>
          <div className="buttons-group">
        ...
        <div className="exchange-info-group">
          <div className="BuyGMXGLP-description">
            <Trans>Buy ODX using any token from any network:</Trans>
          </div>
          <div className="buttons-group">
        ...
        {isArbitrum && (
          <div className="exchange-info-group">
            <div className="BuyGMXGLP-description">
              <Trans>ODX bonds can be bought on Bond Protocol with a discount and a small vesting period:</Trans>
            </div>
            <div className="col-1 buttons-group">
              <Button
                variant="secondary"
                textAlign="left"
                to={"https://app.bondprotocol.finance/#/issuers/ODX"}
...
function CentralisedExchanges({ chainId }) {
  return (
    <Card title={t`Buy ODX from centralized services`}>
      <div className="App-card-content">
        <div className="exchange-info-group">
          <div className="BuyGMXGLP-description">
            <Trans>Buy ODX from centralized exchanges:</Trans>
          </div>
          <div className="buttons-group">
        ...
        <div className="exchange-info-group">
          <div className="BuyGMXGLP-description">
            <Trans>Buy ODX using FIAT gateways:</Trans>
          </div>

  ...
  return (
    <div className="BuyGMXGLP default-container page-layout">
      <div className="BuyGMXGLP-container">
        <div className="section-title-block">
          <div className="section-title-content">
            <div className="Page-title">
              <Trans>Buy NOX on {getChainName(chainId)}</Trans>
            </div>
            <div className="Page-description">
              <Trans>Choose to buy from decentralized or centralized exchanges.</Trans>
              <br />
              <Trans>
                To purchase NOX on the {isArbitrum ? "Avalanche" : "Arbitrum"} blockchain, please{" "}
        ...
        {isArbitrum ? (
          <div className="mt-top section-title-block">
            <div className="section-title-content">
              <div className="Page-title">
...
function DecentralisedExchanges({ chainId, externalLinks }) {
  const isArbitrum = chainId === ARBITRUM;
  return (
    <Card title={t`Buy NOX from decentralized exchanges`}>
      <div className="App-card-content">
        {isArbitrum ? (
          <div className="exchange-info-group">
            <div className="BuyGMXGLP-description">
              <Trans>Buy NOX from Uniswap (make sure to select Arbitrum):</Trans>
            </div>
            <div className="col-1 buttons-group">
              <Button
                variant="secondary"
                textAlign="left"
          ...
          <div className="exchange-info-group">
            <div className="BuyGMXGLP-description">
              <Trans>Buy NOX from Traderjoe:</Trans>
            </div>
            <div className="col-1 buttons-group">
              <Button
                variant="secondary"
        ...
        <div className="exchange-info-group">
          <div className="BuyGMXGLP-description">
            <Trans>Buy NOX using Decentralized Exchange Aggregators:</Trans>
          </div>
          <div className="buttons-group">
        ...
        <div className="exchange-info-group">
          <div className="BuyGMXGLP-description">
            <Trans>Buy NOX using any token from any network:</Trans>
          </div>
          <div className="buttons-group">
        ...
        {isArbitrum && (
          <div className="exchange-info-group">
            <div className="BuyGMXGLP-description">
              <Trans>NOX bonds can be bought on Bond Protocol with a discount and a small vesting period:</Trans>
            </div>
            <div className="col-1 buttons-group">
              <Button
                variant="secondary"
                textAlign="left"
                to={"https://app.bondprotocol.finance/#/issuers/NOX"}
...
function CentralisedExchanges({ chainId }) {
  return (
    <Card title={t`Buy NOX from centralized services`}>
      <div className="App-card-content">
        <div className="exchange-info-group">
          <div className="BuyGMXGLP-description">
            <Trans>Buy NOX from centralized exchanges:</Trans>
          </div>
          <div className="buttons-group">
        ...
        <div className="exchange-info-group">
          <div className="BuyGMXGLP-description">
            <Trans>Buy NOX using FIAT gateways:</Trans>
          </div>
          <div className="col-2 buttons-group">

...
const FUJI_GMX = getContract(AVALANCHE_FUJI, "GMX").toLowerCase();
...
export const EXTERNAL_LINKS = {
  ...
  [AVALANCHE_FUJI]: {
    ...
    buyGmx: {
      traderjoe: `https://app.uniswap.org/#/swap?inputCurrency=ETH&outputCurrency=${FUJI_GMX}`,
    },
  },
};
...
export const FIAT_GATEWAYS: Exchange[] = [
  {
    ...
    links: {
      ...
      [AVALANCHE_FUJI]: "https://www.binancecnt.com/en/buy-sell-crypto",
    },
  },
  {
    name: "Banxa",
    ...
    links: {
      ...
      [AVALANCHE_FUJI]: "https://gmx.banxa.com/?coinType=GMX&fiatType=USD&fiatAmount=500&blockchain=avalanche",
    },
  },
  {
    name: "Transak",
...
export const GMX_FROM_ANY_NETWORKS: Exchange[] = [
  {
    ...
    links: {
      ...
      [AVALANCHE_FUJI]: `https://multitx.bungee.exchange/?toChainId=43114&toTokenAddress=${FUJI_GMX}`,
    },
  },
  {
    name: "O3",
    ...
    links: {
      ...
      [AVALANCHE_FUJI]: `https://o3swap.com/swap?dst_chain=43114&dst_token_hash=${FUJI_GMX}`,
    },
  },
];
...
export const BUY_NATIVE_TOKENS: Exchange[] = [
  {
    ...
    links: {
      ...
      [AVALANCHE_FUJI]: `https://multitx.bungee.exchange/?fromChainId=1&fromTokenAddress=0xeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeee&toChainId=43114&toTokenAddress=0xeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeee`,
    },
  },
  {
    name: "O3",
  ...
  },
  {
    ...
    links: {
      ...
      [AVALANCHE_FUJI]: "https://gmx.banxa.com/?coinType=AVAX&fiatType=USD&fiatAmount=500&blockchain=avalanche",
    },
  },
  {
    name: "Transak",
...
export const TRANSFER_EXCHANGES: Exchange[] = [
  {
    ...
    links: {
      ...
      [AVALANCHE_FUJI]: "https://www.binance.com/en/trade/",
    },
  },
  {
    name: "Synapse",
    ...
    links: {
      ...
      [AVALANCHE_FUJI]: "https://synapseprotocol.com/",
    },
  },
  {
    name: "Arbitrum",
  ...
  },
  {
    ...
    icon: "ic_avax_30.svg",
    links: {
      [AVALANCHE_FUJI]: "https://bridge.avax.network/",
    },
  },
  {
    name: "Hop",
...
export const CENTRALISED_EXCHANGES: Exchange[] = [
  {
    ...
    links: {
      ...
      [AVALANCHE_FUJI]: "https://www.binance.com/en/trade/GMX_USDT",
    },
  },
  {
    name: "Bybit",
    ...
    links: {
      ...
      [AVALANCHE_FUJI]: "https://www.bybit.com/en-US/trade/spot/GMX/USDT",
    },
  },
  {
    name: "Kucoin",
    ...
    links: {
      ...
      [AVALANCHE_FUJI]: "https://www.kucoin.com/trade/GMX-USDT",
    },
  },
  {
    name: "Huobi",
    ...
    links: {
      ...
      [AVALANCHE_FUJI]: "https://www.huobi.com/en-us/exchange/gmx_usdt/",
    },
  },
];
...
export const DECENTRALISED_AGGRIGATORS: Exchange[] = [
  {
    ...
    links: {
      ...
      [AVALANCHE_FUJI]: "https://app.1inch.io/#/43114/unified/swap/AVAX/GMX",
    },
  },
  {
    name: "Matcha",
    ...
    links: {
      ...
      [AVALANCHE_FUJI]: `https://www.matcha.xyz/markets/43114/${FUJI_GMX}`,
    },
  },
  {
    name: "Paraswap",
    ...
    links: {
      ...
      [AVALANCHE_FUJI]: `https://app.paraswap.io/#/${FUJI_GMX}?network=avalanche`,
    },
  },
  {
    name: "KyberSwap",
    ...
    links: {
      ...
      [AVALANCHE_FUJI]: "https://kyberswap.com/swap/avalanche/avax-to-gmx",
    },
  },
  {
    name: "OpenOcean",
    ...
    links: {
      ...
      [AVALANCHE_FUJI]: "https://app.openocean.finance/CLASSIC#/AVAX/AVAX/GMX",
    },
  },
  {
    name: "DODO",
    ...
    links: {
      ...
      [AVALANCHE_FUJI]: `https://app.dodoex.io/?from=AVAX&to=${FUJI_GMX}&network=avalanche`,
    },
  },
  {
    name: "Slingshot",
  ...
  },
  {
    ...
    links: {
      [AVALANCHE_FUJI]: `https://yieldyak.com/swap?outputCurrency=${FUJI_GMX}`,
    },
  },
  {
    name: "Firebird",
    ...
    links: {
      ...
      [AVALANCHE_FUJI]: "https://app.firebird.finance/swap",
    },
  },
  {
    name: "Odos",
    ...
    links: {
      ...
      [AVALANCHE_FUJI]: "https://app.odos.xyz/swap/43114/AVAX/GMX",
    },
  },
];

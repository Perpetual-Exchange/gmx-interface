      ...
      <div className="mt-0 Page-title-section">
        ...
        {isArbitrum && (
          <div>
            <div className="Page-description">
              <br />
              <Trans>You have {formatAmount(esGmxIouBalance, 18, 2, true)} esNOX (IOU) tokens.</Trans>
              <br />
              <br />
              <Trans>The address of the esNOX (IOU) token is {esGmxIouAddress}.</Trans>
              <br />
              <Trans>
                The esNOX (IOU) token is transferrable. You can add the token to your wallet and send it to another
              ...
              <br />
              <Trans>
                After claiming, the esNOX tokens will be airdropped to your account on the selected network within 7
                days.
              </Trans>
              <br />
              <Trans>The esNOX tokens can be staked or vested at any time.</Trans>
              <br />
              <Trans>
                Your esNOX (IOU) balance will decrease by your claim amount after claiming, this is expected behaviour.
              </Trans>
              <br />
              <Trans>
            ...
            <div className="ClaimEsGmx-vesting-options">
              ...
              >
                <Trans>Vest with NOX on Arbitrum</Trans>
              ...
              >
                <Trans>Vest with NLP on Arbitrum</Trans>
                <img src={arbitrumIcon} alt="Arbitrum" />
              </Checkbox>
              <Checkbox
              ...
              >
                <Trans>Vest with NOX on Avalanche</Trans>
              ...
              >
                <Trans>Vest with NLP on Avalanche</Trans>
                <img src={avaIcon} alt="Avalanche" />
              </Checkbox>
            </div>
            <br />
            {!error && (
              <div className="muted">
                <Trans>
                  You can currently vest a maximum of {formatAmount(maxVestableAmount, 18, 2, true)} esNOX tokens at a
                  ratio of {formatAmount(currentRatio, 4, 2, true)} {stakingToken} to 1 esNOX.
                </Trans>
                ...
                <Trans>
                  ...
                  esNOX at a ratio of {formatAmount(nextRatio, 4, 2, true)} {stakingToken} to 1 esNOX.
                </Trans>

...
export function RedirectPopupModal({
  ...
  return (
    <Modal
      ...
      label={t`Launch App`}
    >
      <Trans>You are leaving neonnexus.io and will be redirected to a third party, independent website.</Trans>
      <br />
      <br />
      <Trans>
        The website is a community deployed and maintained instance of the open source{" "}
        <ExternalLink href="https://github.com/gmx-io/gmx-interface">NOX front end</ExternalLink>, hosted and served on
